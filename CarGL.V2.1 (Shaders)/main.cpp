...
int main(int argc, char* argv[])
{
    ...
    TPrimitiva *farola = new TPrimitiva(1,FAROLA_ID);
    TPrimitiva *acera = new TPrimitiva(1,ACERA_ID);
    TPrimitiva *parque = new TPrimitiva(1,PARQUE_ID);
    TPrimitiva *arboles = new TPrimitiva(1,ARBOLES_ID);
    TPrimitiva *casa1 = new TPrimitiva(1,CASA1_ID);
    TPrimitiva *casa12 = new TPrimitiva(1,CASA12_ID);
    TPrimitiva *casa2 = new TPrimitiva(1,CASA2_ID);
    TPrimitiva *casa22 = new TPrimitiva(1,CASA22_ID);
    TPrimitiva *casa3 = new TPrimitiva(1,CASA3_ID);
    TPrimitiva *casa32 = new TPrimitiva(1,CASA32_ID);
    /*
   ;
    ...
    car2->tx = 2;
    car2->tz = 3;
    casa2->colores[0][0]=0.2;
    casa2->ty = 5;
    escena.AddObject(road);
    escena.AddCar(car1);
    escena.AddCar(car2);
    escena.AddObject(farola);
    escena.AddObject(acera);
    escena.AddObject(parque);
